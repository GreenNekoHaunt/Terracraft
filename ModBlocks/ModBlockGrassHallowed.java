...
public class ModBlockGrassHallowed extends ModBlockGrassCorrupted
{
    ...
    public ModBlockGrassHallowed(String name)
    {
        super(name);
        ...
        if (!par1World.isRemote)
        {
            ...
            else
            {
                for (int l = 0; l < 4; ++l)
                {
                    ...
                    {
                        par1World.setBlock(i1, j1, k1, ModBlock.grassHallowed.blockID);
                    }
                    if (par1World.getBlockId(i1, j1, k1) == Block.dirt.blockID 
                        && par1World.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
                    {
