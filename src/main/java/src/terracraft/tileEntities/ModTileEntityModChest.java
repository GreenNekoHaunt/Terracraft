package src.terracraft.tileEntities;
...
public class ModTileEntityModChest extends TileEntity implements IInventory
{
    ...
    private String cachedChestName;
    private String customName;
    private static final String __OBFID = "CL_00000346";

    public ModTileEntityModChest()
    {
        this.cachedChestName = "null";
    }

    @SideOnly(Side.CLIENT)
    public ModTileEntityModChest(String name)
    {
        this.cachedChestName = name;
        this.customName = "container." + name;
    }
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "container.tcChest";
    }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        return block instanceof ModBlockModChest && ((ModBlockModChest)block).getChestType() == this.getChestType();
    }
    ...
    {
        if (this.cachedChestName == "null")
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof ModBlockModChest))
            {
                return "null";
            }
