...
public class ModItemModTool extends ModItem
{
    ...
    protected ModToolMaterial toolMaterial;
    private static final String __OBFID = "CL_00000019";

    protected ModItemModTool(String name, float p_i45333_1_, ModToolMaterial p_i45333_2_, Set p_i45333_3_)
    {
    	super(name);
        ...
        if (this instanceof ModItemModPickaxe)
        {
            toolClass = "pickaxe";
        }
        else if (this instanceof ModItemModAxe)
        {
            toolClass = "axe";
        }
    }
    ...
    public ModToolMaterial func_150913_i()
    {
