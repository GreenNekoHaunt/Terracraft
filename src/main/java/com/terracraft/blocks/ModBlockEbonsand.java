...
public class ModBlockEbonsand extends ModBlockFalling
{
    public ModBlockEbonsand(String name, Material material)
    {
        super(name, material);
...
/*		>> IF WORLD IS HARD MODE <<
                    if (par1World.getBlockId(i1, j1, k1) == Block.stone
                        && par1World.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
                    {
                        par1World.setBlock(i1, j1, k1, ModBlock.ebonstone);
                    }
                    if (par1World.getBlockId(i1, j1, k1) == Block.sand
                        && par1World.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
                    {
                        par1World.setBlock(i1, j1, k1, ModBlock.ebonsand);
                    }
		>> IF END <<
*/
