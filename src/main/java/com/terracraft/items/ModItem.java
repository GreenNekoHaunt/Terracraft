...
public class ModItem extends Item
{
    ...
    public static void initItems()
    {
        ...
        fallenStar = new ModItemFallenStar("fallenStar").setModCreativeTabMaterial();
        crystalMana = new ModItemCrystalMana("crystalMana").setModCreativeTabMaterial();
        potionGreaterHealing = new ModItemPotionHealing("potionGreaterHealing", 2).setModCreativeTabPotion();
        potionHealing = new ModItemPotionHealing("potionHealing", 1).setModCreativeTabPotion();
        potionLesserHealing = new ModItemPotionHealing("potionLesserHealing", 0).setModCreativeTabPotion();
        potionGreaterMana = new ModItemPotionMana("potionGreaterMana", 2).setModCreativeTabPotion();
        potionMana = new ModItemPotionMana("potionMana", 1).setModCreativeTabPotion();
        potionLesserMana = new ModItemPotionMana("potionLesserMana", 0).setModCreativeTabPotion();
        potionGreaterRestoration = new ModItemPotionRestoration("potionGreaterRestoration", 2).setModCreativeTabPotion();
        potionRestoration = new ModItemPotionRestoration("potionRestoration", 1).setModCreativeTabPotion();
        potionLesserRestoration = new ModItemPotionRestoration("potionLesserRestoration", 0).setModCreativeTabPotion();
